...
class LearningSkillIQAdapter extends RecyclerView.Adapter<LearningSkillIQAdapter.LearningViewHolder> {

    //Member variables
    private ArrayList<TopSkillLearner> mLearnerList;
    private Context mContext;

    LearningSkillIQAdapter(Context context, ArrayList<TopSkillLearner> learnerData) {
    ...
    public void onBindViewHolder(LearningViewHolder  holder, int position) {
        ...
        TopSkillLearner currentLearner = mLearnerList.get(position);
    ...
    static class LearningViewHolder extends RecyclerView.ViewHolder{
        ...
        void bindTo(TopSkillLearner currentLearner) {
